...
CREATE OR REPLACE TABLE eds_silver.fact_diagnostic
ENGINE = MergeTree
ORDER BY (code_cim10, stay_id)
COMMENT 'Fait diagnostic (grain : 1 code CIM-10 par séjour) — fait sans mesure, sert aux cohortes'
AS
WITH dedup AS
(
    SELECT
