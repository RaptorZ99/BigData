...
- **`width: "full"` sur les dashboards** : le défaut `fixed` enferme la grille dans ~1 000 px et laisse deux marges vides. Posé dans `ensure_dashboard`, jamais à la main dans l'UI.
